...
The sharpest instrument is the **deletion test**: would deleting this concentrate complexity, or just move it? If the complexity vanishes, it was a pass-through. If the same complexity reappears across several callers, it was earning its keep.
